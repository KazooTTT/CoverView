...
const MobileMockupTheme = ({ config }: { config: SettingsProps }) => {
  ...
  return (
    <div className="p-4 bg-white">
      ...
      >
        ...
        <div className="w-5/12 m-4 mt-10 group mx-auto h-full shadow-lg flex flex-col bg-white border-t-8 border-x-8 rounded-t-3xl border-white">
